...
from app.schemas.Response.passengerResponseDTO import (
    PassengerResponse,
...
class PassengerService:
    async def create_passenger(
        ...
        return PassengerResponse.model_validate(new_passenger)
    ...
    async def passenger_list(
        ...
        return PassengerListResponse.model_validate(
    ...
    async def update_passenger(
        ...
        await db.flush()
        return PassengerResponse.model_validate(existing_passenger)
