...
class Bookings(BaseModel):
    ...
    # 10-digit PNR — generated by booking service, globally unique
    pnr_number: Mapped[str] = mapped_column(String(10), nullable=False, unique=True)
    # BookingStatus enum: initiated / confirmed / waitlisted / rac / cancelled / refund_pending / refund_completed
