...
from app.domain.auth.constants.auth_user import Gender
from app.domain.passenger.constants.passenger import IdType
from app.domain.train.constants.train import BerthType
from app.domain.auth.constants.auth_user import Gender
