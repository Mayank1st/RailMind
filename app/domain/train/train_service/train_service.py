...
from app.domain.train.dto.train_response_dto import (
    TrainDetailResponseDTO,
    CoachWiseSeatAvailabilityResponseDTO,
)
...
class TrainService:
    ...
    async def search_trains_list(
        ...
        try:
            ...
            if payload.train_type:
                conditions.append(Trains.train_type == payload.train_type.upper())
    ...
    async def get_train_details_by_train_number(
        ...
        try:
            ...
            return TrainDetailResponseDTO.model_validate(data)
        except Exception as e:
            print(f"Error: {e}")
            raise
    ...
    async def get_seat_availability_by_coach_number(
        ...
        return CoachWiseSeatAvailabilityResponseDTO.model_validate(
            {
                "train_number": train_data.train_number,
                "train_name": train_data.train_name,
