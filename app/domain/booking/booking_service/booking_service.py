...
from app.domain.train.constants.train import Quota
...
from app.domain.booking.dto.booking_request_dto import CreateBookingDTO, FarePreviewDTO
from app.domain.booking.dto.booking_response_dto import GetBookingDetailsByIdResponseDTO
...
from app.domain.passenger.passenger_service.passenger_service import PassengerService
...
class BookingService:
    ...
    async def get_booking_details_by_id(
        ...
        return GetBookingDetailsByIdResponseDTO(
